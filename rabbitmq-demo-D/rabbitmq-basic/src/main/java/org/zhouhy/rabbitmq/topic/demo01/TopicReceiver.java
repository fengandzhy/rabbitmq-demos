...
public class TopicReceiver {
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        channel.queueBind(RabbitMQConstants.TOPIC_QUEUE_NAME_01,
                RabbitMQConstants.TOPIC_EXCHANGE_NAME_01,RabbitMQConstants.TOPIC_ROUTINE_KEY_01);

        Consumer consumer = CommUtil.createConsumer(channel);

        channel.basicConsume(RabbitMQConstants.TOPIC_QUEUE_NAME_01, true, consumer);
    }
}
